...
const AsusProfileToggle = () => {
  // Set default profile when component initializes
  Utils.idle(() => {
  ...
  Menu({
    ...
    content: [
          ...
          Widget.Box({
            ...
            children: asusctl.profiles.map((prof) =>
              Widget.Button({
                ...
                child: Widget.Box({
                  children: [Widget.Icon(icons.asusctl.profile[prof]), Widget.Label(prof)],
                }),
              })
            ),
          }),
      ...
      Widget.Button({
        ...
        child: Widget.Box({
          children: [Widget.Icon(icons.ui.settings), Widget.Label("Rog Control Center")],
        }),
      }),
    ],
  })
...
export const ProfileToggle = asusctl.available ? AsusProfileToggle : PowerProfileToggle

export const ProfileSelector = asusctl.available ? AsusProfileSelector : PowerProfileSelector
